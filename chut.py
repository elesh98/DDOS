...
TELEGRAM_BOT_TOKEN = '7592440711:AAEwHh_QHm0bA2ogkdAUQIBaab6MWvk2ie0'
ADMIN_USER_ID = 7471974865
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*📢 Channel: [ELESH Channel](https://t.me/+03wLVBPurPk2NWRl)*"
    )
...
async def approve(update: Update, context: CallbackContext):
    ...
    if chat_id != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ You need to get permission to use this command. Contact @LOLOLOLOLOLOL89.*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*🤡 You need to get permission to use this bot. Contact owner @LOLOLOLOLOLOL89.*", parse_mode='Markdown')
        return
